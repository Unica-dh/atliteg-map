      ...
      <div className="relative z-10 max-w-[1600px] mx-auto px-2 md:px-4 py-1">
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2 flex-shrink-0 max-w-[580px] lg:max-w-[660px]">
            ...
            <div className="hidden md:block">
              ...
              <p className="text-white/90 text-[11px] leading-[1.3] mt-0.5">
                PRIN 2017X8CZTM - PI prof.ssa Giovanna Frosini, Università per Stranieri di Siena. Elaborato sui dati estrapolati dal "Vocabolario storico della lingua italiana della gastronomia (VoSLIG)", in collaborazione con il Labego "Giuseppe Cerasa", Università Roma Tre.
              </p>
            </div>
          </div>
          ...
          <nav className="hidden md:flex flex-1 justify-center min-w-0">
            <ul className="flex flex-nowrap gap-0.5 items-center justify-center">
              {menuItems.map((item, index) => (
                ...
                >
                  ...
                  >
                    {item.label}
                    <ChevronDown size={12} className={`transition-transform ${openDropdown === index ? 'rotate-180' : ''}`} />
                  </button>
